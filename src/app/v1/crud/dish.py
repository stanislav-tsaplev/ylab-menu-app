...
def create_dish(submenu_id: UUID, dish_creating_data: DishCreate) -> DishCreated | None:
...
def update_dish(dish_id: UUID, dish_updating_data: DishUpdate) -> DishUpdated | None:
